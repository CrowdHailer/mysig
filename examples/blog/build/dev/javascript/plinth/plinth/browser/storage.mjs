...
export const Estimate$Estimate = (quota, usage) => new Estimate(quota, usage);
export const Estimate$isEstimate = (value) => value instanceof Estimate;
export const Estimate$Estimate$quota = (value) => value.quota;
export const Estimate$Estimate$0 = (value) => value.quota;
export const Estimate$Estimate$usage = (value) => value.usage;
export const Estimate$Estimate$1 = (value) => value.usage;
