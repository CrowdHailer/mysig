...
export const Format$Raw = () => new Raw();
export const Format$isRaw = (value) => value instanceof Raw;

export class Pkcs8 extends $CustomType {}
export const Format$Pkcs8 = () => new Pkcs8();
export const Format$isPkcs8 = (value) => value instanceof Pkcs8;

export class Spki extends $CustomType {}
export const Format$Spki = () => new Spki();
export const Format$isSpki = (value) => value instanceof Spki;
...
export class Ed25519GenParams extends $CustomType {}
export const PublicKeyAlgorithm$Ed25519GenParams = () => new Ed25519GenParams();
export const PublicKeyAlgorithm$isEd25519GenParams = (value) =>
  value instanceof Ed25519GenParams;
...
function format_to_string(format) {
  if (format instanceof Raw) {
    return "raw";
  } else if (format instanceof Pkcs8) {
    return "pkcs8";
  } else {
    return "spki";
  }
 ...
 */
export function export$(key, format) {
  return do_export(format_to_string(format), key);
}
