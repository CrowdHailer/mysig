...
import {
  ...
  removeAttribute as remove_attribute,
  getBoundingClientRect as get_bounding_client_rect,
  ...
  clientHeight as client_height,
  clientLeft as client_left,
  clientTop as client_top,
  clientWidth as client_width,
  ...
  parentElement as parent_element,
...
import * as $dom_rect from "../../plinth/browser/dom_rect.mjs";
...
export const Position$BeforeBegin = () => new BeforeBegin();
export const Position$isBeforeBegin = (value) => value instanceof BeforeBegin;

export class AfterBegin extends $CustomType {}
export const Position$AfterBegin = () => new AfterBegin();
export const Position$isAfterBegin = (value) => value instanceof AfterBegin;

export class BeforeEnd extends $CustomType {}
export const Position$BeforeEnd = () => new BeforeEnd();
export const Position$isBeforeEnd = (value) => value instanceof BeforeEnd;

export class AfterEnd extends $CustomType {}
export const Position$AfterEnd = () => new AfterEnd();
export const Position$isAfterEnd = (value) => value instanceof AfterEnd;
